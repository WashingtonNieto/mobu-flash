...
<head>
    ...
    <title>Mobu Flash - Iniciar Sesión</title>
...
<body style="display: flex; justify-content: center; align-items: center; min-height: 100vh; background-color: var(--bg-main);">
    ...
    <div class="modal" style="width: 100%; max-width: 400px; box-shadow: var(--shadow-lg);">
        ...
        <h2 style="text-align: center; font-size: 20px; margin-bottom: 20px;">Iniciar Sesión</h2>
        ...
        <form action="index.php?action=do_login" method="POST">
            ...
            <button type="submit" class="btn-primary" style="width: 100%; margin-top: 10px;">Ingresar</button>
        </form>

        <p style="text-align: center; margin-top: 20px; font-size: 13px; color: var(--text-muted);">
            ¿No tienes una cuenta? <a href="index.php?action=register" style="color: var(--primary); font-weight: 600; text-decoration: none;">Regístrate</a>
        </p>
    </div>
